...
//        [self addSubview:alphaiView];
       //装载商品信息的视图
        whiteView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
        ...
        img.image = [UIImage imageNamed:@"鞋子"];
        ...
        [bt_cancle setBackgroundImage:[UIImage imageNamed:@"close"] forState:0];
