//
//  Store_ShipmentsViewController.m
//  YiWeiTe
//
...
@interface Store_ShipmentsViewController ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation Store_ShipmentsViewController
