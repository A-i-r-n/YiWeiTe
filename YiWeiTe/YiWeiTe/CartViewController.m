...
-(void)countPrice {
    ...
    for (CartModel *model in selectGoods) {
        ...
        double price = [model.dateStr doubleValue];
...
-(void)setupBottomView {
    //底部视图的 背景
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT -44 -50, SCREEN_WIDTH, 50)];
...
//    UILabel *bottomLine = [[UILabel alloc]initWithFrame:CGRectMake(0, 50, ScreenWidth, 1)];
//    line.backgroundColor = kUIColorFromRGB(0xD5D5D5);
//    [bgView addSubview:bottomLine];
    ...
    priceLabel.textColor = SELECT_TEXTCOLOR;
    [bgView addSubview:priceLabel];
    
    //结算按钮
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    btn.backgroundColor = SELECT_TEXTCOLOR;
...
-(void)setupMainView
{
    ...
    //当购物车不为空时,tableView展示
        ...
        myTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 44 - 50) style:UITableViewStylePlain];
