...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        detailAddrLbl.text = [NSString stringWithFormat:@"%@  %@",dataModel.areaStr,dataModel.detailAddr];
    }else{
...
-(void)jumpToAddAddrPage:(AddrDataModel*)dataModel{
    AddrDetailViewController *viewCtl = [[AddrDetailViewController alloc]init];
