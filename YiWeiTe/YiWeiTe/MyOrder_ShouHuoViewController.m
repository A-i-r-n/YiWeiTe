//
//  MyOrder_ShouHuoViewController.m
//  YiWeiTe
//
...
@interface MyOrder_ShouHuoViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong)UITableView *tableView;
@end

@implementation MyOrder_ShouHuoViewController
