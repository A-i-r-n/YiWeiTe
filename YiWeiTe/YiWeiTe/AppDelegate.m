...
- (void)setupViewControllers {
    ...
    UIViewController *secondViewController = [[StoreViewController alloc] init];
    UIViewController *secondNavigationController = [[UINavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    UIViewController *thirdViewController = [[MyTreasureViewController alloc] init];
    UIViewController *thirdNavigationController = [[UINavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    UIViewController *fourthController = [[CartViewController alloc] init];
...
- (void)customizeTabBarForController:(RDVTabBarController *)tabBarController {
    ...
    NSArray *tabBarItemTitle = @[@"首页",@"商家",@"我的夺宝",@"购物车",@"我的"];
    NSInteger index = 0;
    for (RDVTabBarItem *item in [[tabBarController tabBar] items]) {
        ...
        item.selectedTitleAttributes = @{
                                         ...
                                         NSForegroundColorAttributeName: SELECT_TEXTCOLOR,
                                         };
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "dql.YiWeiTe" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"YiWeiTe" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"YiWeiTe.sqlite"];
    NSError *error = nil;
